...
- **결과:** 엄격한 하드웨어 강결합(Strict Binding)에서 탈피하여 정비 편의성을 극대화하면서도, EU CRA(사이버 복원력 법안)가 요구하는 생애주기 추적성을 만족한다. → [REF-03](../참조-CRA배경/REF-03-추적성-적합성-개요.md)
...
| v1.2 | 2026-07-11 | **확정:** TGU 로컬(.der)·클라우드(.pem)는 동일 부품 정품 인증서의 인코딩 차이임을 명시(§3·§4.1). |
