...
![그림 1 · EPOS-10i 업데이트 워크플로](assets/epos-10i-워크플로.svg)

*[그림 1] EPOS-10i 업데이트 워크플로*

### 2.2 런타임 실행 단계

아래 번호는 [그림 2]의 시퀀스 번호와 일치한다.

![그림 2 · EPOS-10i 런타임 시퀀스](assets/epos-10i-런타임-시퀀스.svg)

*[그림 2] EPOS-10i 런타임 시퀀스*
...
![그림 3 · 서명 검증 상세](assets/서명검증-상세.svg)
